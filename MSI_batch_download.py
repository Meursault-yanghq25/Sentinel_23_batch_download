...
#!!!  云量过滤条件（例：小于10%） modify by @yhq210
cloud_cover = "Attributes/OData.CSC.DoubleAttribute/any(att:att/Name eq 'cloudCover' and att/OData.CSC.DoubleAttribute/Value le 40.00)"
...
request_url=base_prefix+str_in_name+" and "+collection+" and "+roi+" and "+cloud_cover+" and "+time_range+search_lim+expand_assets
...
# http -> https modify by @yhq210
wget_str=[]
part1='''wget  --header "Authorization: Bearer '''
part2='''" "https://catalogue.dataspace.copernicus.eu/odata/v1/Products('''
part3=''')/$value" -O '''
